...
enum StyleFamilyCatalog {
    ...
    static let boho = StyleFamily(
        ...
        palette: .init(primary: "off-white plaster", secondary: "sun-bleached terracotta",
                       accent: "sage green", woodTone: "warm oak", metal: "aged brass"),
        materials: .init(walls: "hand-troweled plaster", floor: "wide oak planks",
                         upholstery: "natural linen and boucle", accentMaterials: ["rattan", "raw ceramic", "jute"]),
        lighting: .init(daylight: "morning sun, warm and diffused",
                        interiorFixtures: ["woven pendant", "brass candlestick lamps"]),
    ...
    static let belgianTransitional = StyleFamily(
        ...
        palette: .init(primary: "warm putty white", secondary: "faded ink",
                       accent: "aged stone", woodTone: "dark walnut", metal: "rubbed bronze"),
        materials: .init(walls: "limewash", floor: "reclaimed oak, matte",
                         upholstery: "washed Belgian linen", accentMaterials: ["patinated leather", "handmade ceramic", "bluestone"]),
        lighting: .init(daylight: "north-facing overcast, silvery and even",
                        interiorFixtures: ["black iron pendant", "linen shaded table lamps"]),
    ...
    static let japandi = StyleFamily(
        ...
        palette: .init(primary: "warm off-white", secondary: "ash",
                       accent: "moss green", woodTone: "pale oak", metal: "blackened steel"),
        materials: .init(walls: "smooth clay plaster", floor: "pale oak, oiled",
                         upholstery: "natural cotton, undyed wool", accentMaterials: ["paper", "washi", "stoneware"]),
        lighting: .init(daylight: "diffuse eastern morning light",
                        interiorFixtures: ["paper lantern", "black slim floor lamp"]),
    ...
    static let parisianClassic = StyleFamily(
        ...
        palette: .init(primary: "ivory limewash", secondary: "faded rose",
                       accent: "gilt", woodTone: "walnut parquet", metal: "polished brass"),
        materials: .init(walls: "limewash with cornice", floor: "herringbone walnut parquet",
                         upholstery: "silk-linen blend, worn velvet", accentMaterials: ["gilt", "marble", "toile"]),
        lighting: .init(daylight: "tall-window Parisian morning",
                        interiorFixtures: ["crystal wall sconces", "small crystal chandelier"]),
    ...
    static let warmMinimal = StyleFamily(
        ...
        palette: .init(primary: "warm white", secondary: "sand",
                       accent: "terracotta", woodTone: "honey oak", metal: "matte brass"),
        materials: .init(walls: "smooth painted plaster", floor: "wide oak plank",
                         upholstery: "boucle, natural cotton", accentMaterials: ["travertine", "unglazed ceramic"]),
        lighting: .init(daylight: "soft midday, warm-cast",
                        interiorFixtures: ["single alabaster pendant", "paper shade floor lamp"]),
    ...
    static let gentlemansLibrary = StyleFamily(
        ...
        palette: .init(primary: "deep ink walls", secondary: "cognac leather",
                       accent: "burgundy", woodTone: "aged mahogany", metal: "polished brass"),
        materials: .init(walls: "painted deep ink or bookcase-lined", floor: "dark parquet or Persian carpet",
                         upholstery: "aged leather, wool tweed", accentMaterials: ["mahogany", "brass", "green banker's glass"]),
        lighting: .init(daylight: "shuttered afternoon, low and warm",
                        interiorFixtures: ["green glass banker's lamp", "brass sconces", "reading lamp"]),
    ...
    static let coastalNordic = StyleFamily(
        ...
        palette: .init(primary: "chalk white", secondary: "pale gray-blue",
                       accent: "driftwood", woodTone: "bleached pine", metal: "pewter"),
        materials: .init(walls: "matte white paint", floor: "bleached pine, wide plank",
                         upholstery: "washed cotton, natural wool", accentMaterials: ["driftwood", "stoneware", "linen"]),
        lighting: .init(daylight: "cool northern morning, bright and even",
                        interiorFixtures: ["simple paper pendant", "iron candle sconces"]),
    ...
    static let moroccanRiad = StyleFamily(
        ...
        palette: .init(primary: "sand tadelakt", secondary: "saffron",
                       accent: "indigo tile", woodTone: "carved cedar", metal: "hammered brass"),
        materials: .init(walls: "polished tadelakt plaster", floor: "hand-glazed zellige tile",
                         upholstery: "raw wool, camel leather", accentMaterials: ["hammered brass", "carved cedar", "zellige mosaic"]),
        lighting: .init(daylight: "filtered through mashrabiya, dappled and warm",
                        interiorFixtures: ["pierced brass lantern", "small brass tea lights"]),
    ...
    static let californiaHacienda = StyleFamily(
        ...
        palette: .init(primary: "adobe cream", secondary: "burnt sienna",
                       accent: "eucalyptus green", woodTone: "distressed mesquite", metal: "wrought iron"),
        materials: .init(walls: "hand-troweled lime plaster", floor: "saltillo terracotta tile",
                         upholstery: "washed leather, cotton canvas", accentMaterials: ["mesquite", "wrought iron", "raw ceramic"]),
        lighting: .init(daylight: "late golden hour, warm and directional",
                        interiorFixtures: ["wrought iron chandelier", "carved wooden sconces"]),
    ...
    static let englishCountryHouse = StyleFamily(
        ...
        palette: .init(primary: "warm chalk", secondary: "moss and burgundy chintz",
                       accent: "brass and hunting green", woodTone: "aged oak", metal: "brass"),
        materials: .init(walls: "matte painted or chintz-papered", floor: "wide oak with Persian runners",
                         upholstery: "chintz, tweed, worn leather", accentMaterials: ["oak", "brass", "porcelain"]),
        lighting: .init(daylight: "overcast british morning, silvery",
                        interiorFixtures: ["porcelain lamp bases", "brass picture lights", "candle sconces"]),
    ...
    static let mediterraneanFarmhouse = StyleFamily(
        ...
        palette: .init(primary: "chalk white plaster", secondary: "olive green",
                       accent: "sun-baked ochre", woodTone: "cypress and olive wood", metal: "hammered iron"),
        materials: .init(walls: "rough plaster, whitewashed", floor: "terracotta tile or worn stone",
                         upholstery: "washed linen, raw wool", accentMaterials: ["olive wood", "hand-thrown ceramic", "iron"]),
        lighting: .init(daylight: "provencal midday, warm and dry",
                        interiorFixtures: ["forged iron chandelier", "olive wood candlesticks"]),
    ...
    static let mountainLodge = StyleFamily(
        ...
        palette: .init(primary: "smoked cedar walls", secondary: "cream shearling",
                       accent: "hunter green", woodTone: "hand-hewn timber", metal: "blackened iron"),
        materials: .init(walls: "vertical timber planking", floor: "wide plank pine or slate",
                         upholstery: "shearling, wool tartan, thick leather", accentMaterials: ["antler", "iron", "stone"]),
        lighting: .init(daylight: "alpine morning through frosted window",
                        interiorFixtures: ["iron antler chandelier", "candle lanterns"]),
    ...
    static let artDeco = StyleFamily(
        ...
        palette: .init(primary: "champagne", secondary: "ink black",
                       accent: "peacock teal", woodTone: "black lacquer", metal: "polished chrome and brass"),
        materials: .init(walls: "lacquered or veneered", floor: "geometric marble or dark parquet",
                         upholstery: "velvet, satin", accentMaterials: ["mirror", "polished chrome", "black lacquer"]),
        lighting: .init(daylight: "filtered through etched glass, dramatic",
                        interiorFixtures: ["fan-shaped sconces", "geometric chandelier"]),
    ...
    static let italianRenaissanceRevival = StyleFamily(
        ...
        palette: .init(primary: "buttermilk fresco", secondary: "faded verdigris",
                       accent: "aged gilt", woodTone: "aged walnut", metal: "verdigris bronze"),
        materials: .init(walls: "hand-painted fresco or venetian plaster", floor: "cotto terracotta or veined marble",
                         upholstery: "faded silk damask", accentMaterials: ["carved walnut", "gilt frame", "aged bronze"]),
        lighting: .init(daylight: "tuscan afternoon through tall windows",
                        interiorFixtures: ["bronze candelabra", "small chandelier with hand-blown glass"]),
    ...
    static let industrialLoft = StyleFamily(
        ...
        palette: .init(primary: "warm brick", secondary: "raw concrete",
                       accent: "oxblood leather", woodTone: "reclaimed timber", metal: "blackened steel"),
        materials: .init(walls: "exposed brick or raw concrete", floor: "polished concrete or reclaimed plank",
                         upholstery: "aged leather, canvas", accentMaterials: ["blackened steel", "reclaimed timber", "riveted iron"]),
        lighting: .init(daylight: "bright through tall industrial windows",
                        interiorFixtures: ["factory pendant", "exposed edison bulbs on iron cage"]),
    ...
    static let wabiSabi = StyleFamily(
        ...
        palette: .init(primary: "unbleached earth", secondary: "moss and stone",
                       accent: "clay red", woodTone: "reclaimed cedar", metal: "hand-forged iron"),
        materials: .init(walls: "clay or rammed earth", floor: "worn stone or cedar plank",
                         upholstery: "undyed hemp, raw silk", accentMaterials: ["kintsugi ceramic", "raw wood", "hand-forged iron"]),
        lighting: .init(daylight: "single directional shaft, meditative",
                        interiorFixtures: ["paper lantern", "single beeswax candle"]),
    ...
    static let shakerModern = StyleFamily(
        ...
        palette: .init(primary: "chalk white", secondary: "milk paint blue",
                       accent: "cherry wood", woodTone: "cherry and pine", metal: "matte iron"),
        materials: .init(walls: "matte painted", floor: "wide pine plank",
                         upholstery: "natural cotton and wool", accentMaterials: ["cherry wood", "iron", "natural cotton"]),
        lighting: .init(daylight: "clean north-facing morning",
                        interiorFixtures: ["simple iron pendant", "candle sconce"]),
    ...
    static let tropicalModernist = StyleFamily(
        ...
        palette: .init(primary: "coconut white", secondary: "deep teak",
                       accent: "botanical green", woodTone: "solid teak", metal: "aged brass"),
        materials: .init(walls: "smooth white plaster", floor: "solid teak plank",
                         upholstery: "natural cotton, rattan weave", accentMaterials: ["teak", "rattan", "raw ceramic"]),
        lighting: .init(daylight: "filtered through banana leaves, dappled green-gold",
                        interiorFixtures: ["woven rattan pendant", "teak floor lamp"]),
...
struct StyleSelection: Codable, Hashable {
    ...
    func composeDNA() -> StyleDNA {
        ...
        if let v = overrides.metal { palette.metal = v }
        if let v = overrides.daylight { lighting.daylight = v }
